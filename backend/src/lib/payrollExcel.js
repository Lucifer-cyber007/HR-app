...
const COLUMNS = [
  ...
  { header: "Transportation Allowance", key: "transportAllowance", width: 16 },
  { header: "Special Allowance", key: "specialAllowance", width: 14 },
  { header: "Medical Allowance", key: "statutoryBonus", width: 14 },
